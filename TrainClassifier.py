...
short_pos = open("short_reviews/positive.txt","rb")
short_neg = open("short_reviews/negative.txt","rb")

documents = []
all_words = []

for r in short_pos:
    documents.append( (r.decode('utf-8'), "pos") )
    short_pos_words = word_tokenize(r.decode('utf-8'),language='english')    
    for w in short_pos_words:
        all_words.append(w.lower())
        
for r in short_neg:
    documents.append( (r.decode('utf-8'), "neg") )
    short_neg_words = word_tokenize(r.decode('utf-8'),language='english')
